<template>
    <div>
        ...
        <div class="jf_2">
            <van-row>
                <van-col span="2" offset="1"><div class="jf_1">类型</div></van-col>
                <van-col span="10"><div class="jf_1">交易号</div></van-col>
                <van-col span="4"><div class="jf_1">获取积分</div></van-col>
                <van-col span="6"><div class="jf_1">时间</div></van-col>
            </van-row>
        </div>
        <div v-if="!list[0]">
            <div class="s_2"></div>
        ...
        <div class="jf_4" v-if="list[0]">
            <van-row v-for="(item,index) in list" v-bind:key="index">
                <van-col span="4"><div class="jf_3">{{item.name}}</div></van-col>
                <van-col span="10"><div class="jf_3">{{item.orderNum}}</div></van-col>
                <van-col span="4"><div class="jf_3">{{item.score}}</div></van-col>
                <van-col span="6"><div class="jf_3">{{item.time}}</div></van-col>
            </van-row>
        </div>
    </div>
</template>
