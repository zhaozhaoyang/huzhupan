<template>
    <div>
        ...
        <div class="jf_2">
            <van-row>
                <van-col span="2"><div class="jf_1">类型</div></van-col>
                <van-col span="6"><div class="jf_1">交易号</div></van-col>
                <van-col span="5"><div class="jf_1">购物者</div></van-col>
                <van-col span="2"><div class="jf_1">获利</div></van-col>
                <van-col span="6"><div class="jf_1">解冻日期</div></van-col>
                <van-col span="3"><div class="jf_1">状态</div></van-col>
            </van-row>
        </div>
        <div v-if="!list[0]">
            <div class="s_2"></div>
        ...
        <div class="jf_4" v-if="list[0]">
            <van-row v-for="(item,index) in list" v-bind:key="index">
                <van-col span="2"><div class="jf_3">{{item.name}}</div></van-col>
                <van-col span="6"><div class="jf_3">{{item.orderNum}}</div></van-col>
                <van-col span="5"><div class="jf_3">{{item.nickName}}</div></van-col>
                <van-col span="2"><div class="jf_3">{{item.reward}}</div></van-col>
                <van-col span="6"><div class="jf_3">{{item.time?item.time:"未来"}}</div></van-col>
                <van-col span="3"><div class="jf_3">{{item.status==1?"已生效":"未生效"}}</div></van-col>
            </van-row>
        </div>
    </div>
</template>
