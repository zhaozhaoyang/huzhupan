<template>
  <div>
    <q-head :noleft="$route.params.id=='no'"></q-head>
    <div class="s_6"></div>
    <div class="xv_1">
      <q-panel>
        ...
        <van-cell-group>
          ...
          <van-field
            ...
            input-align="left"
          />
          <van-field v-if="$route.params.id=='no'" type="number"  v-model.trim="time" label="推荐人：" label-align="right" input-align="left"/>
          <van-field v-if="$route.params.id!='no'" type="text" :readonly="true" v-bind:value="time+' '+peopleName" label="推荐人：" label-align="right" input-align="left"/>
        </van-cell-group>
        <div class="s_2"></div>
      </q-panel>
    </div>
      ...
      <q-panel>
        ...
        <van-cell-group>
          ...
          <van-field
            ...
            input-align="left"
          />
          <van-field v-model.trim="zfb" label="支付宝：" label-align="right" input-align="left" placeholder="选填，不填写也可以注册"/>
          <van-field v-model.trim="remark" label="备注：" label-align="right" input-align="left" placeholder="选填，不填写也可以注册"/>
        </van-cell-group>
        <div class="s_2"></div>
      </q-panel>
    </div>
